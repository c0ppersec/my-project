...
class NodeBuilder {
  ...
  getTextureEncodingFromMap(map) {
    ...
    if (map && map.isTexture) {
      if ('colorSpace' in map) encoding = map.colorSpace === 'srgb' ? 3001 : 3000;else encoding = map.encoding;
    } else if (map && map.isWebGLRenderTarget) {
      if ('colorSpace' in map.texture) encoding = map.texture.colorSpace === 'srgb' ? 3001 : 3000;else encoding = map.texture.encoding;
    } else {
