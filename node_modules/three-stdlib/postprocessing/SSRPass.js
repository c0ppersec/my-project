...
SSRPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  /*, readBuffer, deltaTime, maskActive */
    ...
    if (this.encoding) {
      if ('colorSpace' in this.beautyRenderTarget.texture) this.beautyRenderTarget.texture.colorSpace = this.encoding === 3001 ? 'srgb' : 'srgb-linear';else this.beautyRenderTarget.texture.encoding = this.encoding;
    }
