...
class Reflector extends Mesh {
  constructor(geometry, options = {}) {
    ...
    this.onBeforeRender = function (renderer, scene, camera) {
      ...
      if ('colorSpace' in renderTarget.texture) renderTarget.texture.colorSpace = renderer.outputColorSpace;else renderTarget.texture.encoding = renderer.outputEncoding;
      scope.visible = false;
