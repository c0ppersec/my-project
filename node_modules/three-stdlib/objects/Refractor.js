...
class Refractor extends Mesh {
  constructor(geometry, options = {}) {
    ...
    this.onBeforeRender = function (renderer, scene, camera) {
      // Render
      if ('colorSpace' in renderTarget.texture) renderTarget.texture.colorSpace = renderer.outputColorSpace;else renderTarget.texture.encoding = renderer.outputEncoding; // ensure refractors are rendered only once per frame
